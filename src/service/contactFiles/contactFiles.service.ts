...
import ContactValidator from "../contacts/contactValidator.service";
import CreditCardValidator from "../contacts/creditCardValidator.service";
import EncryptionService from "../encryption.service";

@autoInjectable()
export default class ContactFilesService {
